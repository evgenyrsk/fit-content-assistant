...
- применяет утверждённый `evgeny-style@1.0.0`, выведенный из owner brief по явному делегированию; версия сохраняется с материалом, а factual meaning и caveats остаются неизменяемыми;

...
- применяет утверждённый `evgeny-style@1.1.0`, уточнённый прямой обратной связью владельца о простом разговорном языке; версия сохраняется с материалом, а factual meaning и caveats остаются неизменяемыми;

...
1. Собрать 20–30 реальных вопросов по фитнесу и измерять `recall@10`, долю релевантных full text и долю нерелевантных кандидатов.
2. Добавить PICO-aware reranking по title/abstract, разделить контекст вмешательства и целевой outcome, диверсифицировать выдачу по типам исследований.

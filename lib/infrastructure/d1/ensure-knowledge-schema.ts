...
const knowledgeSchema = [
  ...
  `CREATE TABLE IF NOT EXISTS claim_manual_reviews (
    id TEXT PRIMARY KEY, claim_version_id TEXT NOT NULL UNIQUE REFERENCES claim_versions(id),
    decision TEXT NOT NULL CHECK (decision IN ('approved', 'rejected')),
    reason TEXT NOT NULL, contradictory_evidence_note TEXT NOT NULL,
    provenance_checked INTEGER NOT NULL, scope_checked INTEGER NOT NULL,
    contradictions_checked INTEGER NOT NULL, reviewer_id TEXT NOT NULL, created_at TEXT NOT NULL
  )`,

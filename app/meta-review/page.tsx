...
export default function MetaReviewPage() {
  return (
    <main className="policy-page review-guide" lang="en">
      ...
      <section className="policy-pending"><ShieldAlert aria-hidden="true" /><div><h2>Verification in progress</h2><p>The isolated public guide is live at forme-meta-review.evgenyrsk7.chatgpt.site. Tech Provider status is active and both Threads permissions are in the App Review draft. Business Verification, Access Verification, OAuth screencasts and Meta’s test-call counters must be completed before submission.</p></div></section>
    </main>
  );
}

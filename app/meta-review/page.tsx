...
export default function MetaReviewPage() {
  return (
    <main className="policy-page review-guide" lang="en">
      ...
      <section className="policy-pending"><ShieldAlert aria-hidden="true" /><div><h2>Public portal ready</h2><p>The isolated public guide is live at forme-meta-review.evgenyrsk7.chatgpt.site. Meta requires an irreversible Tech Provider enrollment before these permissions can be added to App Review; that enrollment has not been accepted yet.</p></div></section>
    </main>
  );
}

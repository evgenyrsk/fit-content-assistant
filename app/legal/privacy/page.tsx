...
export default function PrivacyPolicyPage() {
  return (
    <main className="policy-page">
      <nav><Link href="/"><ArrowLeft aria-hidden="true" />Вернуться в Forme</Link><span>Действует с 28 августа 2026</span></nav>
      <header><p className="overline">PRIVACY · VERSION 1</p><h1>Политика конфиденциальности Forme</h1><p>Последнее обновление: 28 августа 2026 года. Публичная версия размещена в изолированном review-контуре без доступа к данным Forme.</p></header>
      ...
      <section className="policy-pending"><Database aria-hidden="true" /><div><h2>Контакт владельца</h2><p><a href="mailto:evgenyrsk7@gmail.com">evgenyrsk7@gmail.com</a>. Подтверждённый запрос на удаление выполняется в течение 30 календарных дней.</p></div></section>
      <footer><span>Forme · privacy v1</span><p>An English reviewer summary is available in the Meta review guide.</p></footer>
    </main>
  );
}
